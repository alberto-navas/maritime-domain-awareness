...
<p align="center">
  <img src="docs/screenshots/map.png" alt="Map generated by the CLI: AIS tracks for several vessels with findings marked by severity (transmission gap, implausible jump, SOG mismatch, sustained encounter, structurally invalid MMSI)" width="800">
</p>
...
62 tests covering all eleven pipeline modules (geo, ingest, tracks,
config, zones, all four detectors, pipeline, report, CLI), using versioned
